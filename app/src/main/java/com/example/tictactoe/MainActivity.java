...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //line below is not needed because we are creating our own layout
    ...
    private class ButtonHandler implements View.OnClickListener {
        public void onClick( View v ) {
            for( int  row = 0; row < TicTacToe.SIDE; row++/*  your code here */   ) {
                for( int column = 0; column < TicTacToe.SIDE; column++/*  your code here */ ) {
    ...
    private class PlayDialog implements DialogInterface.OnClickListener {
        public void onClick( DialogInterface dialog, int id ) {
            if( id == -1 ) /* YES button */ {
                ...
                TicTacToeView.setStatusBackgroundColor( Color.BLUE );
                TicTacToeView.setStatusText( game.result( ) );
            }
